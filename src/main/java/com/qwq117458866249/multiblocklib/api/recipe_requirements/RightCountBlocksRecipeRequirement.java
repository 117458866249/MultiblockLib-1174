...
public class RightCountBlocksRecipeRequirement extends RecipeRequirement {
    public final int value;
    public final ArrayList<String> blocks;

    public RightCountBlocksRecipeRequirement(IOMode io, int value, ArrayList<String> blocks) {
        super(io);
        this.value = value;
        this.blocks = blocks;
    }
